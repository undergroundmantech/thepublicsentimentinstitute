...
// 2020 presidential margins (R+ positive) — the second anchor of §1.1's
// "two most recent presidential elections" fundamentals feature.
export const PRES_2020 = {
  AL: 25.5, AK: 10.1, AZ: -0.3, AR: 27.6, CA: -29.2, CO: -13.5, CT: -20.0,
  DE: -19.0, FL: 3.4, GA: -0.2, HI: -29.5, ID: 30.8, IL: -17.0, IN: 16.1,
  IA: 8.2, KS: 14.6, KY: 25.9, LA: 18.6, ME: -9.1, MD: -33.2, MA: -33.5,
  MI: -2.8, MN: -7.1, MS: 16.5, MO: 15.4, MT: 16.4, NE: 19.1, NV: -2.4,
  NH: -7.4, NJ: -15.9, NM: -10.8, NY: -23.1, NC: 1.3, ND: 33.4, OH: 8.0,
  OK: 33.1, OR: -16.1, PA: -1.2, RI: -20.8, SC: 11.7, SD: 26.2, TN: 23.2,
  TX: 5.6, UT: 20.5, VT: -35.4, VA: -10.1, WA: -19.2, WV: 38.9, WI: -0.6, WY: 43.4,
};
...
export const GOVERNORS = [
  ...
  { st: "GA", inc: 0, open: true,  dem: "Keisha Lance Bottoms", gop: "Burt Jones",     marquee: true },
  ...
  { st: "NE", inc: 1, open: false, dem: "Carol Blood",       gop: "Jim Pillen",        marquee: false },
...
export const GOV_ADJ = {
  VT: 60,   // Scott's crossover brand — R overperformer, so R-positive
  NH: 8,    // Ayotte + NH's R-governor tradition
  NV: -4, MD: 12 /* Hogan crossover */, KS: -16, NY: 6, AZ: -2, WI: -1, MI: 0,
  MA: -6, CT: -2, RI: -2, OK: -6, TN: -6, AL: -6, KY: 0, ME: 0,
  NE: 0,    // Osborn runs for Senate, not governor
...
export const SENATE = [
  ...
  { st: "NE", inc: 1, open: false, dem: "Dan Osborn",        gop: "Pete Ricketts",     marquee: true },   // Osborn runs as an independent
...
export const SEN_ADJ = {
  ME: 4,    // Collins crossover (net of the generic incumbency bonus) vs Mills' brand — Lean D
  ...
  MT: -6, TX: -4, IA: -3, AK: -4, KS: -3, SC: -2, LA: -2,
  NE: -8,   // Osborn's independent crossover appeal
...
export const HOUSE_PVI = {
  ...
  AR: [24, 26, 22, 30],
  CA: [24, -44, -8, -18, 8, -10, -24, -12, -6, -14, -74, -46, 2, -42, -56, -18,
       -62, -30, -26, 32, 1, -8, 16, -34, -8, -18, 1, -32, -48, -36, -12, -40,
       -14, -60, -30, -8, -66, -50, -8, -2, -6, -30, -70, -52, 2, -6, -38, 6,
       -4, -20, -34, -28],
  ...
  HI: [-30, -18],
  ID: [34, 38],
  IL: [-60, -34, -24, -64, -40, -12, -66, -14, -44, -26, -16, 28, -10, -8, 32, 22, -6],
  IN: [-16, 18, 22, 20, 20, 24, -34, 16, 14],
  IA: [2, 1, 3, 16],
  KS: [12, 8, -8, 18],
  ...
  MI: [10, 8, -9, 12, 22, -8, 1, 2, 20, 4, -30, -48, -46],
  ...
  NC: [8, -30, 16, -32, 20, 24, 22, 18, 14, 20, 26, -52, 3, -18],
  ND: [26],
  OH: [3, 12, -38, 24, 22, 14, 18, 20, 2, 16, -56, 10, 1, 26, 5],
  OK: [30, 24, 36, 22, 12],
  OR: [-24, 22, -42, -6, -3, -8],
  PA: [-2, -18, -76, -18, -30, -8, 1, 2, 30, 5, 24, -12, 32, 20, 28, 12, -4],
  RI: [-24, -18],
  SC: [1, 20, 26, 18, 24, -44, 12],
  SD: [30],
  TN: [26, 30, 28, 32, -12, 24, 20, 22, -50],
  TX: [22, 20, 24, 32, 16, 26, -22, 12, -66, 20, 34, 18, 36, 6, 3, -16, 14,
       -56, 26, -22, 8, 10, 5, 12, 24, 20, 6, 10, -46, -60, 10, -22, -30, 9,
       -12, 26, -24, 30],
  UT: [16, -20, 14, 22],
  VT: [-32],
  VA: [-4, 1, -34, -62, 15, 16, -6, -42, 20, 6, -30],
...
export const HOUSE_KEY = {
  ...
  "IA-02": { dem: "Sarah Corkery",     gop: "Joe Mitchell",     inc: 0 },   // Hinson runs for Senate
  "IA-03": { dem: "Lanon Baccam",      gop: "Zach Nunn",        inc: 1 },
  "ME-02": { dem: "Matt Dunlap",       gop: "Paul LePage",      inc: 0 },   // Golden retired Oct 2025
  ...
  "MI-10": { dem: "Carl Marlinga",     gop: "Alicia St. Germaine", inc: 0 }, // James runs for governor
  ...
  "NH-01": { dem: "Stefany Shaheen",   gop: "Chris Bright",     inc: 0 },   // Pappas runs for Senate
  ...
  "NY-19": { dem: "Josh Riley",        gop: "Peter Oberacker",  inc: -1 },  // Molinaro heads the FTA
  ...
  "OR-05": { dem: "Janelle Bynum",     gop: "Amy Ryan Courser", inc: -1 },  // Chavez-DeRemer is Labor Secretary
  ...
  "WA-03": { dem: "Marie Gluesenkamp Perez", gop: "Leslie Lewallen", inc: -1 }, // Kent directs the NCTC
...
// Seats whose sitting member is running statewide in this file — forced open
export const VACATED = new Set(["FL-19", "GA-01", "IA-04", "WI-07", "NY-21", "KY-06"]);
...
export function buildHouse() {
  ...
  for (const [st, pvis] of Object.entries(HOUSE_PVI)) {
    pvis.forEach((pvi, k) => {
      ...
      const h = djb2("hs·" + id);
      const holdsR = pvi > 0;
      const open = key ? key.inc === 0 : VACATED.has(id) || h % 100 < 12;
