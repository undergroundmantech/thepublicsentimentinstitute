...
export const ACTUAL_TRUMP  = 45.9;
export const ACTUAL_HARRIS = 51.9;
      ...
      <div className="pa24-root">
        ...
        <div className="pa24-hero">
          ...
          <div className="pa24-hero-inner">
            <div>
              <div className="pa24-eyebrow">2024 Presidential Election · New Mexico · Archive</div>
              <h1 className="pa24-hero-title">
                <span className="gold">New Mexico</span><br />
        ...
        <PollingTimeSeriesChart
          ...
          yDomain={[40, 56]}
          title="2024 New Mexico Presidential polling average"
