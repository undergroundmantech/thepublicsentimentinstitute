...
export const ACTUAL_TRUMP  = 52.2;
export const ACTUAL_HARRIS = 46.7;
      ...
      <div className="pa24-root">
        ...
        <div className="pa24-hero">
          ...
          <div className="pa24-hero-inner">
            <div>
              <div className="pa24-eyebrow">2024 Presidential Election · Arizona · Archive</div>
              <h1 className="pa24-hero-title">
                <span className="gold">Arizona</span><br />
        ...
        <PollingTimeSeriesChart
          ...
          yDomain={[40, 56]}
          title="2024 Arizona Presidential polling average"
