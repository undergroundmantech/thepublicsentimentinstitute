...
export const ACTUAL_TRUMP  = 46.7;
export const ACTUAL_HARRIS = 51.0;
      ...
      <div className="pa24-root">
        ...
        <div className="pa24-hero">
          ...
          <div className="pa24-hero-inner">
            <div>
              <div className="pa24-eyebrow">2024 Presidential Election · Minnesota · Archive</div>
              <h1 className="pa24-hero-title">
                <span className="gold">Minnesota</span><br />
        ...
        <PollingTimeSeriesChart
          ...
          yDomain={[40, 56]}
          title="2024 Minnesota Presidential polling average"
