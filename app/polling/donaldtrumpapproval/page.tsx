...
const STATE_RAW: Record<string, { civiqs: number; economist: number; mc: number }> = {
  AL: { civiqs: 11,  economist: 3,     mc: 16  },
  AK: { civiqs: -1,  economist: -8.8,  mc: -1  },
  AZ: { civiqs: -10, economist: -14.1, mc: 4   },
  AR: { civiqs: 15,  economist: 2.4,   mc: 15  },
  CA: { civiqs: -43, economist: -27,   mc: -23 },
  CO: { civiqs: -25, economist: -26.4, mc: -16 },
  CT: { civiqs: -32, economist: -33.4, mc: -21 },
  DE: { civiqs: -32, economist: -23.4, mc: -14 },
  DC: { civiqs: -85, economist: -85,   mc: -85 },
  FL: { civiqs: -7,  economist: -6.7,  mc: 2   },
  GA: { civiqs: -17, economist: -17.9, mc: -5  },
  HI: { civiqs: -58, economist: -37.8, mc: -34 },
  ID: { civiqs: 13,  economist: 28,    mc: 23  },
  IL: { civiqs: -32, economist: -34.1, mc: -21 },
  IN: { civiqs: 4,   economist: -11.1, mc: 0   },
  IA: { civiqs: -10, economist: -10.9, mc: -2  },
  KS: { civiqs: 3,   economist: -7.7,  mc: 1   },
  KY: { civiqs: 7,   economist: -3.6,  mc: 12  },
  LA: { civiqs: 0,   economist: -1.6,  mc: 12  },
  ME: { civiqs: -22, economist: -23,   mc: -14 },
  MD: { civiqs: -47, economist: -38.1, mc: -34 },
  MA: { civiqs: -45, economist: -30.2, mc: -32 },
  MI: { civiqs: -20, economist: -16.7, mc: -9  },
  MN: { civiqs: -23, economist: -21.3, mc: -11 },
  MS: { civiqs: 1,   economist: -3,    mc: 11  },
  MO: { civiqs: 1,   economist: -4.9,  mc: 7   },
  MT: { civiqs: 10,  economist: 3.8,   mc: 4   },
  NE: { civiqs: 3,   economist: -3.5,  mc: 6   },
  NV: { civiqs: -17, economist: -16.4, mc: -5  },
  NH: { civiqs: -29, economist: -18.2, mc: -12 },
  NJ: { civiqs: -30, economist: -22.3, mc: -13 },
  NM: { civiqs: -25, economist: -31.2, mc: -16 },
  NY: { civiqs: -35, economist: -25.9, mc: -17 },
  NC: { civiqs: -11, economist: -11.9, mc: -6  },
  ND: { civiqs: 15,  economist: 9.7,   mc: 15  },
  OH: { civiqs: -5,  economist: -13.1, mc: -1  },
  OK: { civiqs: 19,  economist: 3,     mc: 14  },
  OR: { civiqs: -36, economist: -29.4, mc: -23 },
  PA: { civiqs: -15, economist: -19.4, mc: -3  },
  RI: { civiqs: -38, economist: -32.6, mc: -26 },
  SC: { civiqs: -3,  economist: -8.2,  mc: 5   },
  SD: { civiqs: 12,  economist: -1.9,  mc: 10  },
  TN: { civiqs: 9,   economist: 5.1,   mc: 17  },
  TX: { civiqs: -9,  economist: -16.7, mc: 2   },
  UT: { civiqs: 6,   economist: 1.5,   mc: 7   },
  VT: { civiqs: -54, economist: -42,   mc: -35 },
  VA: { civiqs: -23, economist: -16.1, mc: -12 },
  WA: { civiqs: -40, economist: -35.2, mc: -21 },
  WV: { civiqs: 24,  economist: 16.4,  mc: 20  },
  WI: { civiqs: -11, economist: -18.8, mc: -10 },
  WY: { civiqs: 19,  economist: 21.9,  mc: 33  },
};
