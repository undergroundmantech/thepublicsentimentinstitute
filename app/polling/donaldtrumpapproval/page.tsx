...
const STATE_RAW: Record<string, { civiqs: number; economist: number; mc: number }> = {
  AL: { civiqs: 12,   economist: 0.1,   mc: 16   },
  AK: { civiqs: -12,  economist: -10.8, mc: -1   },
  AZ: { civiqs: -9,   economist: -16.5, mc: 4    },
  AR: { civiqs: 15,   economist: -1.6,  mc: 15   },
  CA: { civiqs: -42,  economist: -29.1, mc: -23  },
  CO: { civiqs: -24,  economist: -28.2, mc: -16  },
  CT: { civiqs: -33,  economist: -35.6, mc: -21  },
  DE: { civiqs: -35,  economist: -26.2, mc: -14  },
  DC: { civiqs: -85,  economist: -85,   mc: -85  }, // unchanged
  FL: { civiqs: -8,   economist: -8.2,  mc: 2    },
  GA: { civiqs: -17,  economist: -21.2, mc: -5   },
  HI: { civiqs: -59,  economist: -40,   mc: -34  },
  ID: { civiqs: 16,   economist: 26,    mc: 23   },
  IL: { civiqs: -31,  economist: -36.3, mc: -21  },
  IN: { civiqs: 4,    economist: -12.8, mc: 0    },
  IA: { civiqs: -8,   economist: -10.9, mc: -2   },
  KS: { civiqs: 3,    economist: -11.7, mc: 1    },
  KY: { civiqs: 5,    economist: -5.3,  mc: 12   },
  LA: { civiqs: 3,    economist: -6.1,  mc: 12   },
  ME: { civiqs: -22,  economist: -23.9, mc: -14  },
  MD: { civiqs: -45,  economist: -40.5, mc: -34  },
  MA: { civiqs: -47,  economist: -33.3, mc: -32  },
  MI: { civiqs: -19,  economist: -17.9, mc: -9   },
  MN: { civiqs: -25,  economist: -23.6, mc: -11  },
  MS: { civiqs: 3,    economist: -3,    mc: 11   },
  MO: { civiqs: 1,    economist: -6.5,  mc: 7    },
  MT: { civiqs: 11,   economist: 2.1,   mc: 4    },
  NE: { civiqs: 5,    economist: -6.1,  mc: 6    },
  NV: { civiqs: -16,  economist: -18.5, mc: -5   },
  NH: { civiqs: -28,  economist: -19.3, mc: -12  },
  NJ: { civiqs: -32,  economist: -23.4, mc: -13  },
  NM: { civiqs: -28,  economist: -33.1, mc: -16  },
  NY: { civiqs: -33,  economist: -27.2, mc: -17  },
  NC: { civiqs: -10,  economist: -13.5, mc: -6   },
  ND: { civiqs: 14,   economist: 7.3,   mc: 15   },
  OH: { civiqs: -5,   economist: -14.8, mc: -1   },
  OK: { civiqs: 19,   economist: 0.2,   mc: 14   },
  OR: { civiqs: -35,  economist: -32.1, mc: -23  },
  PA: { civiqs: -15,  economist: -21,   mc: -3   },
  RI: { civiqs: -37,  economist: -34.7, mc: -26  },
  SC: { civiqs: 0,    economist: -10.9, mc: 5    },
  SD: { civiqs: 11,   economist: -4.6,  mc: 10   },
  TN: { civiqs: 10,   economist: 3,     mc: 17   },
  TX: { civiqs: -8,   economist: -18.7, mc: 2    },
  UT: { civiqs: 6,    economist: 0.1,   mc: 7    },
  VT: { civiqs: -56,  economist: -43.2, mc: -35  },
  VA: { civiqs: -24,  economist: -17.9, mc: -12  },
  WA: { civiqs: -39,  economist: -38.3, mc: -21  },
  WV: { civiqs: 22,   economist: 14,    mc: 20   },
  WI: { civiqs: -12,  economist: -20.6, mc: -10  },
  WY: { civiqs: 23,   economist: 20.9,  mc: 33   },
};
