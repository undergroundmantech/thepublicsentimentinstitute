...
export const ACTUAL_TRUMP  = 51.0;
export const ACTUAL_HARRIS = 47.8;
      ...
      <div className="pa24-root">
        ...
        <div className="pa24-hero">
          ...
          <div className="pa24-hero-inner">
            <div>
              <div className="pa24-eyebrow">2024 Presidential Election · North Carolina · Archive</div>
              <h1 className="pa24-hero-title">
                <span className="gold">North Carolina</span><br />
        ...
        <PollingTimeSeriesChart
          ...
          yDomain={[40, 56]}
          title="2024 North Carolina Presidential polling average"
