...
export const ACTUAL_HARRIS = 47.6;
      ...
      <div className="pa24-root">
        ...
        <div className="pa24-hero">
          ...
          <div className="pa24-hero-inner">
            <div>
              <div className="pa24-eyebrow">2024 Presidential Election · Nevada · Archive</div>
              <h1 className="pa24-hero-title">
                <span className="gold">Nevada</span><br />
        ...
        <PollingTimeSeriesChart
          ...
          yDomain={[40, 56]}
          title="2024 Nevada Presidential polling average"
