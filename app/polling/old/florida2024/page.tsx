...
{ pollster: "Research Co.", endDate: "2024-11-03", sampleSize: 450, sampleType: "LV", results: { Harris: 44, Trump: 51 } },
{ pollster: "Victory Insights", endDate: "2024-11-02", sampleSize: 400, sampleType: "LV", results: { Harris: 47, Trump: 51 } },
{ pollster: "Stetson University", endDate: "2024-11-01", sampleSize: 452, sampleType: "LV", results: { Harris: 46, Trump: 53 } },
{ pollster: "Morning Consult", endDate: "2024-11-01", sampleSize: 2022, sampleType: "LV", results: { Harris: 46, Trump: 51 } },
{ pollster: "Florida Atlantic University", endDate: "2024-10-27", sampleSize: 897, sampleType: "LV", results: { Harris: 44, Trump: 53 } },
{ pollster: "St. Pete Polls", endDate: "2024-10-25", sampleSize: 1227, sampleType: "LV", results: { Harris: 45, Trump: 50 } },
{ pollster: "Hunt Research", endDate: "2024-10-22", sampleSize: 1234, sampleType: "LV", results: { Harris: 45, Trump: 50 } },
{ pollster: "Emerson College", endDate: "2024-10-20", sampleSize: 860, sampleType: "LV", results: { Harris: 44, Trump: 52 } },
{ pollster: "University of North Florida", endDate: "2024-10-18", sampleSize: 977, sampleType: "LV", results: { Harris: 43, Trump: 53 } },
{ pollster: "RMG Research", endDate: "2024-10-17", sampleSize: 788, sampleType: "LV", results: { Harris: 45, Trump: 52 } },
{ pollster: "Rose Institute/YouGov", endDate: "2024-10-17", sampleSize: 1076, sampleType: "LV", results: { Harris: 46, Trump: 51 } },
{ pollster: "The Terrance Group", endDate: "2024-10-08", sampleSize: 818, sampleType: "RV", results: { Harris: 44, Trump: 51 } },
{ pollster: "Marist College", endDate: "2024-10-07", sampleSize: 1257, sampleType: "LV", results: { Harris: 47, Trump: 51 } },
{ pollster: "NY Times/Siena", endDate: "2024-10-06", sampleSize: 622, sampleType: "LV", results: { Harris: 41, Trump: 55 } },
{ pollster: "Mason-Dixon", endDate: "2024-10-04", sampleSize: 625, sampleType: "RV", results: { Harris: 43, Trump: 49 } },
{ pollster: "RMG Research", endDate: "2024-09-27", sampleSize: 774, sampleType: "LV", results: { Harris: 47, Trump: 50 } },
{ pollster: "Public Policy Polling", endDate: "2024-09-26", sampleSize: 800, sampleType: "RV", results: { Harris: 46, Trump: 50 } },
{ pollster: "McLaughlin & Associates", endDate: "2024-09-25", sampleSize: 1200, sampleType: "LV", results: { Harris: 46, Trump: 51 } },
{ pollster: "Victory Insights", endDate: "2024-09-25", sampleSize: 600, sampleType: "LV", results: { Harris: 45, Trump: 47 } },
{ pollster: "The Bullfinch Group", endDate: "2024-09-23", sampleSize: 600, sampleType: "RV", results: { Harris: 47, Trump: 48 } },
{ pollster: "Morning Consult", endDate: "2024-09-18", sampleSize: 2948, sampleType: "LV", results: { Harris: 47, Trump: 50 } },
{ pollster: "Morning Consult", endDate: "2024-09-08", sampleSize: 3182, sampleType: "LV", results: { Harris: 47, Trump: 49 } },
{ pollster: "Emerson College", endDate: "2024-09-05", sampleSize: 815, sampleType: "LV", results: { Harris: 45, Trump: 50 } },
{ pollster: "Public Policy Polling", endDate: "2024-08-22", sampleSize: 837, sampleType: "RV", results: { Harris: 47, Trump: 51 } },
{ pollster: "Florida Atlantic University", endDate: "2024-08-11", sampleSize: 1040, sampleType: "LV", results: { Harris: 47, Trump: 50 } },
{ pollster: "University of North Florida", endDate: "2024-07-27", sampleSize: 774, sampleType: "LV", results: { Harris: 42, Trump: 49 } },
{ pollster: "InsiderAdvantage", endDate: "2024-07-16", sampleSize: 800, sampleType: "RV", results: { Harris: 39, Trump: 49 } },
];

export const ACTUAL_TRUMP  = 56.1;
export const ACTUAL_HARRIS = 43.0;
      ...
      <div className="pa24-root">
        ...
        <div className="pa24-hero">
          ...
          <div className="pa24-hero-inner">
            <div>
              <div className="pa24-eyebrow">2024 Presidential Election · Florida · Archive</div>
              <h1 className="pa24-hero-title">
                <span className="gold">Florida</span><br />
        ...
        <PollingTimeSeriesChart
          ...
          yDomain={[40, 56]}
          title="2024 Florida Presidential polling average"
