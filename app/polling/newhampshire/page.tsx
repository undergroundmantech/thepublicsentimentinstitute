...
export const ACTUAL_TRUMP  = 47.9;
export const ACTUAL_HARRIS = 50.7;
      ...
      <div className="pa24-root">
        ...
        <div className="pa24-hero">
          ...
          <div className="pa24-hero-inner">
            <div>
              <div className="pa24-eyebrow">2024 Presidential Election · New Hampshire · Archive</div>
              <h1 className="pa24-hero-title">
                <span className="gold">New Hampshire</span><br />
        ...
        <PollingTimeSeriesChart
          ...
          yDomain={[40, 56]}
          title="2024 New Hampshire Presidential polling average"
