...
export const ACTUAL_HARRIS = 51.8;
      ...
      <div className="pa24-root">
        ...
        <div className="pa24-hero">
          ...
          <div className="pa24-hero-inner">
            <div>
              <div className="pa24-eyebrow">2024 Presidential Election · Virginia · Archive</div>
              <h1 className="pa24-hero-title">
                <span className="gold">Virginia</span><br />
        ...
        <PollingTimeSeriesChart
          ...
          yDomain={[40, 56]}
          title="2024 Virginia Presidential polling average"
