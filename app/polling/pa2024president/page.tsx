...
{ pollster: "Big Data Poll",               endDate: "2024-10-16", sampleSize: 1200, sampleType: "LV", results: { Harris: 48, Trump: 52 } },
  { pollster: "AtlasIntel",                  endDate: "2024-11-04", sampleSize: 1840, sampleType: "LV", results: { Harris: 48, Trump: 49 } },
  { pollster: "AtlasIntel",                  endDate: "2024-11-02", sampleSize: 2049, sampleType: "LV", results: { Harris: 47, Trump: 49 } },
  ...
  { pollster: "AtlasIntel",                  endDate: "2024-10-29", sampleSize: 1299, sampleType: "LV", results: { Harris: 47, Trump: 49 } },
  ...
  { pollster: "AtlasIntel",                  endDate: "2024-10-17", sampleSize: 2048, sampleType: "LV", results: { Harris: 47, Trump: 50 } },
  ...
  { pollster: "NY Times/Siena",              endDate: "2024-09-16", sampleSize: 1082, sampleType: "LV", results: { Harris: 49, Trump: 45 } },
...
const ACTUAL_TRUMP  = 50.3;
const ACTUAL_HARRIS = 48.4;
      ...
      <div className="pa24-root">
        ...
        <div className="pa24-hero">
          ...
          <div className="pa24-hero-inner">
            <div>
              <div className="pa24-eyebrow">2024 Presidential Election · Pennsylvania · Archive</div>
              <h1 className="pa24-hero-title">
                <span className="gold">Pennsylvania</span><br />
        ...
        <PollingTimeSeriesChart
          ...
          yDomain={[40, 56]}
          title="2024 Pennsylvania Presidential polling average"
