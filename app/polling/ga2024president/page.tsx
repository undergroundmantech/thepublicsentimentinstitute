...
export const ACTUAL_TRUMP  = 50.7;
      ...
      <div className="pa24-root">
        ...
        <div className="pa24-hero">
          ...
          <div className="pa24-hero-inner">
            <div>
              <div className="pa24-eyebrow">2024 Presidential Election · Georgia · Archive</div>
              <h1 className="pa24-hero-title">
                <span className="gold">Georgia</span><br />
        ...
        <PollingTimeSeriesChart
          ...
          yDomain={[40, 56]}
          title="2024 Georgia Presidential polling average"
