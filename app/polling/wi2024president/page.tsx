...
export const ACTUAL_TRUMP  = 49.4;
export const ACTUAL_HARRIS = 48.5;
      ...
      <div className="pa24-root">
        ...
        <div className="pa24-hero">
          ...
          <div className="pa24-hero-inner">
            <div>
              <div className="pa24-eyebrow">2024 Presidential Election · Wisconsin · Archive</div>
              <h1 className="pa24-hero-title">
                <span className="gold">Wisconsin</span><br />
        ...
        <PollingTimeSeriesChart
          ...
          yDomain={[40, 56]}
          title="2024 Wisconsin Presidential polling average"
