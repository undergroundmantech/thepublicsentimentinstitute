...
// ─── Data ──────────────────────────────────────────────────────────────────────
const SENATE_RAW = [
  { state:"AL", name:"Tommy Tuberville",    incRunning:false, incParty:"R" as const, approval:19,  pollingAvg:19.0,  modeledResult:21.4  },
  { state:"AK", name:"Dan Sullivan",         incRunning:true,  incParty:"R" as const, approval:-8,  pollingAvg:-3.4,  modeledResult:-3.5  },
  { state:"AR", name:"Tom Cotton",           incRunning:true,  incParty:"R" as const, approval:15,  pollingAvg:10.5,  modeledResult:14.1  },
  { state:"CO", name:"John Hickenlooper",    incRunning:true,  incParty:"D" as const, approval:-22, pollingAvg:null, modeledResult:-21.7 },
  { state:"DE", name:"Chris Coons",          incRunning:true,  incParty:"D" as const, approval:-20, pollingAvg:null, modeledResult:-27.4 },
  { state:"FL", name:"Ashley Moody",         incRunning:true,  incParty:"R" as const, approval:17,  pollingAvg:6.9,   modeledResult:6.1   },
  ...
  { state:"ME", name:"Susan Collins",        incRunning:true,  incParty:"R" as const, approval:-13, pollingAvg:-0.1,  modeledResult:-4.5 },
  { state:"MA", name:"Ed Markey",            incRunning:true,  incParty:"D" as const, approval:-15, pollingAvg:-26.7, modeledResult:-28.4 },
  { state:"MI", name:"Gary Peters",          incRunning:false, incParty:"D" as const, approval:-17, pollingAvg:-2.7,  modeledResult:-4.1  },
  { state:"MN", name:"Tina Smith",           incRunning:false, incParty:"D" as const, approval:-16, pollingAvg:-3.6,  modeledResult:-10.1 },
  { state:"MS", name:"Cindy Hyde-Smith",     incRunning:true,  incParty:"R" as const, approval:9,   pollingAvg:7.3,   modeledResult:8.3   },
  { state:"MT", name:"Steve Daines",         incRunning:false, incParty:"R" as const, approval:13,  pollingAvg:-2.4,  modeledResult:18.5  },
  { state:"NE", name:"Pete Ricketts",        incRunning:true,  incParty:"R" as const, approval:1,   pollingAvg:3.4,  modeledResult:1.1  },
  { state:"NH", name:"Jeanne Shaheen",       incRunning:false, incParty:"D" as const, approval:12,  pollingAvg:-7.8,  modeledResult:-10.4 },
  { state:"NJ", name:"Cory Booker",          incRunning:true,  incParty:"D" as const, approval:-19, pollingAvg:null, modeledResult:-21.3 },
  { state:"NM", name:"Ben Ray Luján",        incRunning:true,  incParty:"D" as const, approval:-20, pollingAvg:-16.5,  modeledResult:-19.9 },
  { state:"NC", name:"Thom Tillis",          incRunning:false, incParty:"R" as const, approval:4,   pollingAvg:-6.5, modeledResult:-8.4  },
  { state:"OH", name:"Jon Husted",           incRunning:true,  incParty:"R" as const, approval:15,  pollingAvg:-4.7,  modeledResult:-4.9  },
  { state:"OK", name:"James Lankford",       incRunning:true,  incParty:"R" as const, approval:17,  pollingAvg:32.4,  modeledResult:25.8  },
  { state:"OR", name:"Jeff Merkley",         incRunning:true,  incParty:"D" as const, approval:-21, pollingAvg:null, modeledResult:-26.6 },
  { state:"RI", name:"Jack Reed",            incRunning:true,  incParty:"D" as const, approval:-28, pollingAvg:-23.5, modeledResult:-24.2 },
  { state:"SC", name:"Lindsey Graham",       incRunning:true,  incParty:"R" as const, approval:-2,  pollingAvg:2.9,   modeledResult:2.2   },
  { state:"SD", name:"Mike Rounds",          incRunning:true,  incParty:"R" as const, approval:23,  pollingAvg:1.1,  modeledResult:7.3  },
  { state:"TN", name:"Bill Hagerty",         incRunning:true,  incParty:"R" as const, approval:27,  pollingAvg:24.4,  modeledResult:21.2  },
  { state:"TX", name:"John Cornyn",          incRunning:true,  incParty:"R" as const, approval:6,   pollingAvg:-2.4,  modeledResult:-2.9  },
  { state:"VA", name:"Mark Warner",          incRunning:true,  incParty:"D" as const, approval:-25, pollingAvg:-21.7, modeledResult:-20.3 },
  { state:"WV", name:"Shelley Moore Capito", incRunning:true,  incParty:"R" as const, approval:19,  pollingAvg:null,  modeledResult:33.0  },
  { state:"WY", name:"Cynthia Lummis",       incRunning:false, incParty:"R" as const, approval:26,  pollingAvg:null,  modeledResult:41.6  },
];
const GOV_RAW = [
  { state:"AL", name:"Kay Ivey",                  incRunning:false, incParty:"R" as const, approval:31,  pollingAvg:8.9, modeledResult:15.9  },
  { state:"AK", name:"Mike Dunleavy",             incRunning:true,  incParty:"R" as const, approval:11,  pollingAvg:0.7, modeledResult:-12.5  },
  { state:"AZ", name:"Katie Hobbs",               incRunning:true,  incParty:"D" as const, approval:-14, pollingAvg:-5.8, modeledResult:-9.6 },
  { state:"AR", name:"Sarah Huckabee Sanders",    incRunning:true,  incParty:"R" as const, approval:21,  pollingAvg:5.9, modeledResult:11.9  },
  { state:"CA", name:"Gavin Newsom",              incRunning:false, incParty:"D" as const, approval:-12, pollingAvg:-22.9,modeledResult:-26.9 },
  { state:"CO", name:"Jared Polis",               incRunning:false, incParty:"D" as const, approval:-21, pollingAvg:null,modeledResult:-22.3 },
  { state:"CT", name:"Ned Lamont",                incRunning:true,  incParty:"D" as const, approval:-32, pollingAvg:-18.3,modeledResult:-18.6 },
  { state:"FL", name:"Ron DeSantis",              incRunning:false, incParty:"R" as const, approval:13,  pollingAvg:0.8,  modeledResult:2.9   },
  { state:"GA", name:"Brian Kemp",                incRunning:false, incParty:"R" as const, approval:34,  pollingAvg:2.1,  modeledResult:-2.0  },
  { state:"HI", name:"Josh Green",                incRunning:true,  incParty:"D" as const, approval:-33, pollingAvg:null,modeledResult:-41.1 },
  { state:"ID", name:"Brad Little",               incRunning:true,  incParty:"R" as const, approval:16,  pollingAvg:28.0, modeledResult:26.4  },
  { state:"IL", name:"J.B. Pritzker",             incRunning:true,  incParty:"D" as const, approval:-17, pollingAvg:-22.7,modeledResult:-24.2 },
  { state:"IA", name:"Kim Reynolds",              incRunning:false, incParty:"R" as const, approval:-5,  pollingAvg:-5.3, modeledResult:-6.6  },
  { state:"KS", name:"Laura Kelly",               incRunning:false, incParty:"D" as const, approval:-30, pollingAvg:7.0, modeledResult:5.6   },
  { state:"ME", name:"Janet Mills",               incRunning:false, incParty:"D" as const, approval:-7,  pollingAvg:-9.4,modeledResult:-13.6 },
  { state:"MD", name:"Wes Moore",                 incRunning:true,  incParty:"D" as const, approval:-32, pollingAvg:-30.3,modeledResult:-37.0 },
  { state:"MA", name:"Maura Healey",              incRunning:true,  incParty:"D" as const, approval:-29, pollingAvg:-19.6,modeledResult:-26.7 },
  { state:"MI", name:"Gretchen Whitmer",          incRunning:false, incParty:"D" as const, approval:-21, pollingAvg:-7.5, modeledResult:-9.6  },
  { state:"MN", name:"Tim Walz",                  incRunning:false, incParty:"D" as const, approval:-17, pollingAvg:-9.2,modeledResult:-14.4 },
  { state:"NE", name:"Jim Pillen",                incRunning:true,  incParty:"R" as const, approval:15,  pollingAvg:15.5, modeledResult:9.9  },
  { state:"NV", name:"Joe Lombardo",              incRunning:true,  incParty:"R" as const, approval:23,  pollingAvg:-0.8, modeledResult:-4.3   },
  { state:"NH", name:"Kelly Ayotte",              incRunning:true,  incParty:"R" as const, approval:18,  pollingAvg:14.3, modeledResult:7.3   },
  { state:"NM", name:"Michelle Lujan Grisham",    incRunning:false, incParty:"D" as const, approval:-17, pollingAvg:-8.3, modeledResult:-15.1 },
  { state:"NY", name:"Kathy Hochul",              incRunning:true,  incParty:"D" as const, approval:-10, pollingAvg:-4.9,modeledResult:-11.4 },
  { state:"OH", name:"Mike DeWine",               incRunning:false, incParty:"R" as const, approval:21,  pollingAvg:-1.8, modeledResult:-1.8  },
  { state:"OK", name:"Kevin Stitt",               incRunning:false, incParty:"R" as const, approval:18,  pollingAvg:null, modeledResult:22.2  },
  { state:"OR", name:"Tina Kotek",                incRunning:true,  incParty:"D" as const, approval:-4,  pollingAvg:2.3, modeledResult:-9.9 },
  { state:"PA", name:"Josh Shapiro",              incRunning:true,  incParty:"D" as const, approval:-32, pollingAvg:-18.3,modeledResult:-20.9 },
  { state:"RI", name:"Dan McKee",                 incRunning:true,  incParty:"D" as const, approval:-2,  pollingAvg:-43.3,modeledResult:-27.6 },
  { state:"SC", name:"Henry McMaster",            incRunning:false, incParty:"R" as const, approval:22,  pollingAvg:8.7, modeledResult:9.2   },
  { state:"SD", name:"Larry Rhoden",              incRunning:true,  incParty:"R" as const, approval:34,  pollingAvg:null, modeledResult:13.1  },
  { state:"TN", name:"Bill Lee",                  incRunning:false, incParty:"R" as const, approval:27,  pollingAvg:16.5, modeledResult:16.9  },
  { state:"TX", name:"Greg Abbott",               incRunning:true,  incParty:"R" as const, approval:10,  pollingAvg:4.1,  modeledResult:3.8   },
  { state:"VT", name:"Phil Scott",                incRunning:true,  incParty:"R" as const, approval:58,  pollingAvg:-6.3, modeledResult:-5.9  },
  { state:"WI", name:"Tony Evers",                incRunning:false, incParty:"D" as const, approval:-15, pollingAvg:-4.6, modeledResult:-7.0  },
  { state:"WY", name:"Mark Gordon",               incRunning:true,  incParty:"R" as const, approval:34,  pollingAvg:null, modeledResult:38.9  },
];
