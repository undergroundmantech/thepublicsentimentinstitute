...
// ─── Data ──────────────────────────────────────────────────────────────────────
const SENATE_RAW = [
  { state:"AL", name:"Tommy Tuberville",    incRunning:false, incParty:"R" as const, approval:19,  pollingAvg:19.0,  modeledResult:20.3  },
  { state:"AK", name:"Dan Sullivan",         incRunning:true,  incParty:"R" as const, approval:-8,  pollingAvg:-3.4,  modeledResult:-4.1  },
  { state:"AR", name:"Tom Cotton",           incRunning:true,  incParty:"R" as const, approval:15,  pollingAvg:10.5,  modeledResult:13.7  },
  { state:"CO", name:"John Hickenlooper",    incRunning:true,  incParty:"D" as const, approval:-22, pollingAvg:null, modeledResult:-23.8 },
  { state:"DE", name:"Chris Coons",          incRunning:true,  incParty:"D" as const, approval:-20, pollingAvg:null, modeledResult:-29.2 },
  { state:"FL", name:"Ashley Moody",         incRunning:true,  incParty:"R" as const, approval:17,  pollingAvg:6.9,   modeledResult:5.2   },
  { state:"GA", name:"Jon Ossoff",           incRunning:true,  incParty:"D" as const, approval:-18, pollingAvg:-7.6,  modeledResult:-9.7 },
  { state:"ID", name:"Jim Risch",            incRunning:true,  incParty:"R" as const, approval:22,  pollingAvg:-0.7,  modeledResult:12.3  },
  { state:"IL", name:"Dick Durbin",          incRunning:false, incParty:"D" as const, approval:-12, pollingAvg:null, modeledResult:-25.7 },
  { state:"IA", name:"Joni Ernst",           incRunning:false, incParty:"R" as const, approval:-5,  pollingAvg:0.2,   modeledResult:-0.9   },
  { state:"KS", name:"Roger Marshall",       incRunning:true,  incParty:"R" as const, approval:6,   pollingAvg:1.0,   modeledResult:1.7   },
  { state:"KY", name:"Mitch McConnell",      incRunning:false, incParty:"R" as const, approval:-36, pollingAvg:10.1,   modeledResult:15.3   },
  { state:"LA", name:"Bill Cassidy",         incRunning:true,  incParty:"R" as const, approval:9,   pollingAvg:4.3,  modeledResult:8.0  },
  { state:"ME", name:"Susan Collins",        incRunning:true,  incParty:"R" as const, approval:-13, pollingAvg:-0.1,  modeledResult:-5.0 },
  { state:"MA", name:"Ed Markey",            incRunning:true,  incParty:"D" as const, approval:-15, pollingAvg:-26.7, modeledResult:-28.8 },
  { state:"MI", name:"Gary Peters",          incRunning:false, incParty:"D" as const, approval:-17, pollingAvg:-2.7,  modeledResult:-4.3  },
  { state:"MN", name:"Tina Smith",           incRunning:false, incParty:"D" as const, approval:-16, pollingAvg:-3.6,  modeledResult:-10.6 },
  { state:"MS", name:"Cindy Hyde-Smith",     incRunning:true,  incParty:"R" as const, approval:9,   pollingAvg:7.3,   modeledResult:7.7   },
  { state:"MT", name:"Steve Daines",         incRunning:false, incParty:"R" as const, approval:13,  pollingAvg:-2.4,  modeledResult:17.7  },
  { state:"NE", name:"Pete Ricketts",        incRunning:true,  incParty:"R" as const, approval:1,   pollingAvg:3.4,  modeledResult:0.5  },
  { state:"NH", name:"Jeanne Shaheen",       incRunning:false, incParty:"D" as const, approval:12,  pollingAvg:-7.8,  modeledResult:-10.7 },
  { state:"NJ", name:"Cory Booker",          incRunning:true,  incParty:"D" as const, approval:-19, pollingAvg:null, modeledResult:-22.9 },
  { state:"NM", name:"Ben Ray Luján",        incRunning:true,  incParty:"D" as const, approval:-20, pollingAvg:-16.5,  modeledResult:-20.8 },
  { state:"NC", name:"Thom Tillis",          incRunning:false, incParty:"R" as const, approval:4,   pollingAvg:-6.5, modeledResult:-8.8  },
  { state:"OH", name:"Jon Husted",           incRunning:true,  incParty:"R" as const, approval:15,  pollingAvg:-4.7,  modeledResult:-5.5  },
  { state:"OK", name:"James Lankford",       incRunning:true,  incParty:"R" as const, approval:17,  pollingAvg:32.4,  modeledResult:24.9  },
  { state:"OR", name:"Jeff Merkley",         incRunning:true,  incParty:"D" as const, approval:-21, pollingAvg:null, modeledResult:-28.0 },
  { state:"RI", name:"Jack Reed",            incRunning:true,  incParty:"D" as const, approval:-28, pollingAvg:-23.5, modeledResult:-24.8 },
  { state:"SC", name:"Lindsey Graham",       incRunning:true,  incParty:"R" as const, approval:-2,  pollingAvg:2.9,   modeledResult:1.7   },
  { state:"SD", name:"Mike Rounds",          incRunning:true,  incParty:"R" as const, approval:23,  pollingAvg:1.1,  modeledResult:6.7  },
  { state:"TN", name:"Bill Hagerty",         incRunning:true,  incParty:"R" as const, approval:27,  pollingAvg:24.4,  modeledResult:20.4  },
  { state:"TX", name:"John Cornyn",          incRunning:true,  incParty:"R" as const, approval:6,   pollingAvg:-2.4,  modeledResult:-2.9  },
  { state:"VA", name:"Mark Warner",          incRunning:true,  incParty:"D" as const, approval:-25, pollingAvg:-21.7, modeledResult:-20.8 },
  { state:"WV", name:"Shelley Moore Capito", incRunning:true,  incParty:"R" as const, approval:19,  pollingAvg:null,  modeledResult:31.2  },
  { state:"WY", name:"Cynthia Lummis",       incRunning:false, incParty:"R" as const, approval:26,  pollingAvg:null,  modeledResult:40.2  },
];
const GOV_RAW = [
  { state:"AL", name:"Kay Ivey",                  incRunning:false, incParty:"R" as const, approval:31,  pollingAvg:8.9, modeledResult:15.2  },
  { state:"AK", name:"Mike Dunleavy",             incRunning:true,  incParty:"R" as const, approval:11,  pollingAvg:0.7, modeledResult:-13.4  },
  { state:"AZ", name:"Katie Hobbs",               incRunning:true,  incParty:"D" as const, approval:-14, pollingAvg:-5.8, modeledResult:-10.2 },
  { state:"AR", name:"Sarah Huckabee Sanders",    incRunning:true,  incParty:"R" as const, approval:21,  pollingAvg:5.9, modeledResult:11.3  },
  { state:"CA", name:"Gavin Newsom",              incRunning:false, incParty:"D" as const, approval:-12, pollingAvg:-23.1,modeledResult:-27.7 },
  { state:"CO", name:"Jared Polis",               incRunning:false, incParty:"D" as const, approval:-21, pollingAvg:null,modeledResult:-24.2 },
  { state:"CT", name:"Ned Lamont",                incRunning:true,  incParty:"D" as const, approval:-32, pollingAvg:-18.2,modeledResult:-19.3 },
  { state:"FL", name:"Ron DeSantis",              incRunning:false, incParty:"R" as const, approval:13,  pollingAvg:0.8,  modeledResult:2.2   },
  { state:"GA", name:"Brian Kemp",                incRunning:false, incParty:"R" as const, approval:34,  pollingAvg:2.1,  modeledResult:-2.4  },
  { state:"HI", name:"Josh Green",                incRunning:true,  incParty:"D" as const, approval:-33, pollingAvg:null,modeledResult:-43.0 },
  { state:"ID", name:"Brad Little",               incRunning:true,  incParty:"R" as const, approval:16,  pollingAvg:28.0, modeledResult:25.7  },
  { state:"IL", name:"J.B. Pritzker",             incRunning:true,  incParty:"D" as const, approval:-17, pollingAvg:-22.7,modeledResult:-24.9 },
  { state:"IA", name:"Kim Reynolds",              incRunning:false, incParty:"R" as const, approval:-5,  pollingAvg:-5.3, modeledResult:-7.0  },
  { state:"KS", name:"Laura Kelly",               incRunning:false, incParty:"D" as const, approval:-30, pollingAvg:7.0, modeledResult:4.9   },
  { state:"ME", name:"Janet Mills",               incRunning:false, incParty:"D" as const, approval:-7,  pollingAvg:-9.4,modeledResult:-14.5 },
  { state:"MD", name:"Wes Moore",                 incRunning:true,  incParty:"D" as const, approval:-32, pollingAvg:-30.3,modeledResult:-37.4 },
  { state:"MA", name:"Maura Healey",              incRunning:true,  incParty:"D" as const, approval:-29, pollingAvg:-19.6,modeledResult:-27.5 },
  { state:"MI", name:"Gretchen Whitmer",          incRunning:false, incParty:"D" as const, approval:-21, pollingAvg:-7.5, modeledResult:-10.2  },
  { state:"MN", name:"Tim Walz",                  incRunning:false, incParty:"D" as const, approval:-17, pollingAvg:-9.2,modeledResult:-15.0 },
  { state:"NE", name:"Jim Pillen",                incRunning:true,  incParty:"R" as const, approval:15,  pollingAvg:15.5, modeledResult:9.2  },
  { state:"NV", name:"Joe Lombardo",              incRunning:true,  incParty:"R" as const, approval:23,  pollingAvg:-0.9, modeledResult:-5.1   },
  { state:"NH", name:"Kelly Ayotte",              incRunning:true,  incParty:"R" as const, approval:18,  pollingAvg:14.2, modeledResult:6.8   },
  { state:"NM", name:"Michelle Lujan Grisham",    incRunning:false, incParty:"D" as const, approval:-17, pollingAvg:-8.2, modeledResult:-15.8 },
  { state:"NY", name:"Kathy Hochul",              incRunning:true,  incParty:"D" as const, approval:-10, pollingAvg:-4.9,modeledResult:-12.0 },
  { state:"OH", name:"Mike DeWine",               incRunning:false, incParty:"R" as const, approval:21,  pollingAvg:-1.9, modeledResult:-2.5  },
  { state:"OK", name:"Kevin Stitt",               incRunning:false, incParty:"R" as const, approval:18,  pollingAvg:null, modeledResult:20.4  },
  { state:"OR", name:"Tina Kotek",                incRunning:true,  incParty:"D" as const, approval:-4,  pollingAvg:2.3, modeledResult:-10.6 },
  { state:"PA", name:"Josh Shapiro",              incRunning:true,  incParty:"D" as const, approval:-32, pollingAvg:-18.3,modeledResult:-21.4 },
  { state:"RI", name:"Dan McKee",                 incRunning:true,  incParty:"D" as const, approval:-2,  pollingAvg:-43.3,modeledResult:-28.0 },
  { state:"SC", name:"Henry McMaster",            incRunning:false, incParty:"R" as const, approval:22,  pollingAvg:8.7, modeledResult:8.4   },
  { state:"SD", name:"Larry Rhoden",              incRunning:true,  incParty:"R" as const, approval:34,  pollingAvg:null, modeledResult:10.8  },
  { state:"TN", name:"Bill Lee",                  incRunning:false, incParty:"R" as const, approval:27,  pollingAvg:16.5, modeledResult:16.2  },
  { state:"TX", name:"Greg Abbott",               incRunning:true,  incParty:"R" as const, approval:10,  pollingAvg:4.1,  modeledResult:3.6   },
  { state:"VT", name:"Phil Scott",                incRunning:true,  incParty:"R" as const, approval:58,  pollingAvg:-6.3, modeledResult:-6.6  },
  { state:"WI", name:"Tony Evers",                incRunning:false, incParty:"D" as const, approval:-15, pollingAvg:-4.6, modeledResult:-7.7  },
  { state:"WY", name:"Mark Gordon",               incRunning:true,  incParty:"R" as const, approval:34,  pollingAvg:null, modeledResult:37.3  },
];
