...
const SENATE_RAW = [
  { state:"AL", senator:"Tommy Tuberville",     incRunning:false, incParty:"R" as const, approval:   19, pollingAvg:    19.0, modeledResult:  21.4 },
  { state:"AK", senator:"Dan Sullivan",         incRunning:true , incParty:"R" as const, approval:   -8, pollingAvg:  -3.4, modeledResult:  -3.5 },
  { state:"AR", senator:"Tom Cotton",           incRunning:true , incParty:"R" as const, approval:   15, pollingAvg:  10.5, modeledResult:  14.1 },
  { state:"CO", senator:"John Hickenlooper",    incRunning:true , incParty:"D" as const, approval:  -22, pollingAvg: null, modeledResult: -21.7 },
  { state:"DE", senator:"Chris Coons",          incRunning:true , incParty:"D" as const, approval:  -20, pollingAvg: null, modeledResult: -27.4 },
  { state:"FL", senator:"Ashley Moody",         incRunning:true , incParty:"R" as const, approval:   17, pollingAvg:     6.9, modeledResult:   6.1 },
  { state:"GA", senator:"Jon Ossoff",           incRunning:true , incParty:"D" as const, approval:  -18, pollingAvg:    -7.6, modeledResult: -9.1 },
  { state:"ID", senator:"Jim Risch",            incRunning:true , incParty:"R" as const, approval:   22, pollingAvg:    -0.7, modeledResult:  13.0 },
  { state:"IL", senator:"Dick Durbin",          incRunning:false, incParty:"D" as const, approval:  -12, pollingAvg: null, modeledResult: -24.5 },
  { state:"IA", senator:"Joni Ernst",           incRunning:false, incParty:"R" as const, approval:   -5, pollingAvg:   0.2, modeledResult:  -0.6 },
  { state:"KS", senator:"Roger Marshall",       incRunning:true , incParty:"R" as const, approval:    6, pollingAvg:   1.0, modeledResult:   2.4 },
  { state:"KY", senator:"Mitch McConnell",      incRunning:false, incParty:"R" as const, approval:  -36, pollingAvg:     10.1, modeledResult:     16.0 },
  { state:"LA", senator:"Bill Cassidy",         incRunning:true , incParty:"R" as const, approval:    9, pollingAvg:  4.3, modeledResult:  8.6 },
  { state:"ME", senator:"Susan Collins",        incRunning:true , incParty:"R" as const, approval:  -13, pollingAvg:     -0.1, modeledResult:  -4.5 },
  { state:"MA", senator:"Ed Markey",            incRunning:true , incParty:"D" as const, approval:  -15, pollingAvg: -26.7, modeledResult: -28.4 },
  { state:"MI", senator:"Gary Peters",          incRunning:false, incParty:"D" as const, approval:  -17, pollingAvg:  -2.7, modeledResult:  -4.1 },
  { state:"MN", senator:"Tina Smith",           incRunning:false, incParty:"D" as const, approval:  -16, pollingAvg:  -3.6, modeledResult: -10.1 },
  { state:"MS", senator:"Cindy Hyde-Smith",     incRunning:true , incParty:"R" as const, approval:    9, pollingAvg:     7.3, modeledResult:    8.3 },
  { state:"MT", senator:"Steve Daines",         incRunning:false, incParty:"R" as const, approval:   13, pollingAvg:  -2.4, modeledResult:  18.5 },
  { state:"NE", senator:"Pete Ricketts",        incRunning:true , incParty:"R" as const, approval:    1, pollingAvg:   3.4, modeledResult:   1.1 },
  { state:"NH", senator:"Jeanne Shaheen",       incRunning:false, incParty:"D" as const, approval:   12, pollingAvg:  -7.8, modeledResult: -10.4 },
  { state:"NJ", senator:"Cory Booker",          incRunning:true , incParty:"D" as const, approval:  -19, pollingAvg: null, modeledResult: -21.3 },
  { state:"NM", senator:"Ben Ray Luján",        incRunning:true , incParty:"D" as const, approval:  -20, pollingAvg:  -16.5, modeledResult: -19.9 },
  { state:"NC", senator:"Thom Tillis",          incRunning:false, incParty:"R" as const, approval:    4, pollingAvg:  -6.5, modeledResult:    -8.4 },
  { state:"OH", senator:"Jon Husted",           incRunning:true , incParty:"R" as const, approval:   15, pollingAvg:   -4.7, modeledResult:   -4.9 },
  { state:"OK", senator:"James Lankford",       incRunning:true , incParty:"R" as const, approval:   17, pollingAvg:    32.4, modeledResult:  25.8 },
  { state:"OR", senator:"Jeff Merkley",         incRunning:true , incParty:"D" as const, approval:  -21, pollingAvg: null, modeledResult: -26.6 },
  { state:"RI", senator:"Jack Reed",            incRunning:true , incParty:"D" as const, approval:  -28, pollingAvg: -23.5, modeledResult: -24.2 },
  { state:"SC", senator:"Lindsey Graham",       incRunning:false, incParty:"R" as const, approval:   -2, pollingAvg:     2.9, modeledResult:  2.2 },
  { state:"SD", senator:"Mike Rounds",          incRunning:true , incParty:"R" as const, approval:   23, pollingAvg:    1.1, modeledResult:    7.3 },
  { state:"TN", senator:"Bill Hagerty",         incRunning:true , incParty:"R" as const, approval:   27, pollingAvg:  24.4, modeledResult:  21.2 },
  { state:"TX", senator:"John Cornyn",          incRunning:false, incParty:"R" as const, approval:    6, pollingAvg:   -2.4, modeledResult:  -2.9 },
  { state:"VA", senator:"Mark Warner",          incRunning:true , incParty:"D" as const, approval:  -25, pollingAvg: -21.7, modeledResult: -20.3 },
  { state:"WV", senator:"Shelley Moore Capito", incRunning:true , incParty:"R" as const, approval:   19, pollingAvg:  null, modeledResult:  33.0 },
  { state:"WY", senator:"Cynthia Lummis",       incRunning:false, incParty:"R" as const, approval:   26, pollingAvg:  null, modeledResult:  41.6 },
];
...
const GOV_RAW = [
  { state:"AL", governor:"Kay Ivey",               incRunning:false, incParty:"R" as const, approval:   20, pollingAvg:    8.9, modeledResult:  15.9 },
  { state:"AK", governor:"Mike Dunleavy",          incRunning:true , incParty:"R" as const, approval:  -11, pollingAvg:    0.7, modeledResult:  -12.5 },
  { state:"AZ", governor:"Katie Hobbs",            incRunning:true , incParty:"D" as const, approval:  -14, pollingAvg:  -5.8, modeledResult:  -9.6 },
  { state:"AR", governor:"Sarah Huckabee Sanders", incRunning:true , incParty:"R" as const, approval:   19, pollingAvg:     5.9, modeledResult:  11.9 },
  { state:"CA", governor:"Gavin Newsom",           incRunning:false, incParty:"D" as const, approval:  -26, pollingAvg: -22.9, modeledResult: -26.9 },
  { state:"CO", governor:"Jared Polis",            incRunning:false, incParty:"D" as const, approval:  -21, pollingAvg:   null, modeledResult:   -22.3 },
  { state:"CT", governor:"Ned Lamont",             incRunning:true , incParty:"D" as const, approval:  -33, pollingAvg:   -18.3, modeledResult: -18.6 },
  { state:"FL", governor:"Ron DeSantis",           incRunning:false, incParty:"R" as const, approval:   15, pollingAvg:   0.8, modeledResult:   2.9 },
  { state:"GA", governor:"Brian Kemp",             incRunning:false, incParty:"R" as const, approval:   32, pollingAvg:  2.1, modeledResult:  -2.0 },
  { state:"HI", governor:"Josh Green",             incRunning:true , incParty:"D" as const, approval:  -27, pollingAvg:   null, modeledResult: -41.1 },
  { state:"ID", governor:"Brad Little",            incRunning:true , incParty:"R" as const, approval:   30, pollingAvg:    28.0, modeledResult:  26.4 },
  { state:"IL", governor:"J. B. Pritzker",         incRunning:true , incParty:"D" as const, approval:  -17, pollingAvg:   -22.7, modeledResult: -24.2 },
  { state:"IA", governor:"Kim Reynolds",           incRunning:false, incParty:"R" as const, approval:   -6, pollingAvg:  -5.3, modeledResult:  -6.6 },
  { state:"KS", governor:"Laura Kelly",            incRunning:false, incParty:"D" as const, approval:  -26, pollingAvg:    7.0, modeledResult:    5.6 },
  { state:"ME", governor:"Janet Mills",            incRunning:false, incParty:"D" as const, approval:   -8, pollingAvg:   -9.4, modeledResult: -13.6 },
  { state:"MD", governor:"Wes Moore",              incRunning:true , incParty:"D" as const, approval:  -33, pollingAvg:   -30.3, modeledResult: -37.0 },
  { state:"MA", governor:"Maura Healey",           incRunning:true , incParty:"D" as const, approval:  -33, pollingAvg: -19.6, modeledResult: -26.7 },
  { state:"MI", governor:"Gretchen Whitmer",       incRunning:false, incParty:"D" as const, approval:  -25, pollingAvg:  -7.5, modeledResult: -9.6 },
  { state:"MN", governor:"Tim Walz",               incRunning:false, incParty:"D" as const, approval:   -7, pollingAvg:  -9.2, modeledResult: -14.4 },
  { state:"NE", governor:"Jim Pillen",             incRunning:true , incParty:"R" as const, approval:    6, pollingAvg:   15.5, modeledResult:   9.9 },
  { state:"NV", governor:"Joe Lombardo",           incRunning:true , incParty:"R" as const, approval:   18, pollingAvg:   -0.8, modeledResult:   -4.3 },
  { state:"NH", governor:"Kelly Ayotte",           incRunning:true , incParty:"R" as const, approval:   23, pollingAvg:   14.3, modeledResult:   7.3 },
  { state:"NM", governor:"Michelle Lujan Grisham", incRunning:false, incParty:"D" as const, approval:  -16, pollingAvg:   -8.3, modeledResult: -15.1 },
  { state:"NY", governor:"Kathy Hochul",           incRunning:true , incParty:"D" as const, approval:  -19, pollingAvg: -4.9, modeledResult: -11.4 },
  { state:"OH", governor:"Mike DeWine",            incRunning:false, incParty:"R" as const, approval:   18, pollingAvg:   -1.8, modeledResult:  -1.8 },
  { state:"OK", governor:"Kevin Stitt",            incRunning:false, incParty:"R" as const, approval:    6, pollingAvg:    null, modeledResult:  22.2 },
  { state:"OR", governor:"Tina Kotek",             incRunning:true , incParty:"D" as const, approval:   -6, pollingAvg:  2.3, modeledResult:  -9.9 },
  { state:"PA", governor:"Josh Shapiro",           incRunning:true , incParty:"D" as const, approval:  -34, pollingAvg: -18.3, modeledResult: -20.9 },
  { state:"RI", governor:"Dan McKee",              incRunning:true , incParty:"D" as const, approval:  -12, pollingAvg:   -43.3, modeledResult:   -27.6 },
  { state:"SC", governor:"Henry McMaster",         incRunning:false, incParty:"R" as const, approval:   18, pollingAvg:    8.7, modeledResult:   9.2 },
  { state:"SD", governor:"Larry Rhoden",           incRunning:true , incParty:"R" as const, approval:   28, pollingAvg:    null, modeledResult:  13.1 },
  { state:"TN", governor:"Bill Lee",               incRunning:false, incParty:"R" as const, approval:   26, pollingAvg:    16.5, modeledResult:  16.9 },
  { state:"TX", governor:"Greg Abbott",            incRunning:true , incParty:"R" as const, approval:   12, pollingAvg:   4.1, modeledResult:   3.8 },
  { state:"VT", governor:"Phil Scott",             incRunning:true , incParty:"R" as const, approval:   55, pollingAvg:    -6.3, modeledResult:    -5.9 },
  { state:"WI", governor:"Tony Evers",             incRunning:false, incParty:"D" as const, approval:  -19, pollingAvg:  -4.6, modeledResult:  -7.0 },
  { state:"WY", governor:"Mark Gordon",            incRunning:true , incParty:"R" as const, approval:   42, pollingAvg:    null, modeledResult:  38.9 },
];
