...
const SENATE_RAW = [
  { state:"AL", senator:"Tommy Tuberville",     incRunning:false, incParty:"R" as const, approval:   19, pollingAvg:    19.0, modeledResult:  20.3 },
  { state:"AK", senator:"Dan Sullivan",         incRunning:true , incParty:"R" as const, approval:   -8, pollingAvg:  -3.4, modeledResult:  -4.1 },
  { state:"AR", senator:"Tom Cotton",           incRunning:true , incParty:"R" as const, approval:   15, pollingAvg:  10.5, modeledResult:  13.7 },
  { state:"CO", senator:"John Hickenlooper",    incRunning:true , incParty:"D" as const, approval:  -22, pollingAvg: null, modeledResult: -23.8 },
  { state:"DE", senator:"Chris Coons",          incRunning:true , incParty:"D" as const, approval:  -20, pollingAvg: null, modeledResult: -29.2 },
  { state:"FL", senator:"Ashley Moody",         incRunning:true , incParty:"R" as const, approval:   17, pollingAvg:     6.9, modeledResult:   5.2 },
  { state:"GA", senator:"Jon Ossoff",           incRunning:true , incParty:"D" as const, approval:  -18, pollingAvg:    -7.6, modeledResult: -9.7 },
  { state:"ID", senator:"Jim Risch",            incRunning:true , incParty:"R" as const, approval:   22, pollingAvg:    -0.7, modeledResult:  12.3 },
  { state:"IL", senator:"Dick Durbin",          incRunning:false, incParty:"D" as const, approval:  -12, pollingAvg: null, modeledResult: -25.7 },
  { state:"IA", senator:"Joni Ernst",           incRunning:false, incParty:"R" as const, approval:   -5, pollingAvg:   0.2, modeledResult:  -0.9 },
  { state:"KS", senator:"Roger Marshall",       incRunning:true , incParty:"R" as const, approval:    6, pollingAvg:   1.0, modeledResult:   1.7 },
  { state:"KY", senator:"Mitch McConnell",      incRunning:false, incParty:"R" as const, approval:  -36, pollingAvg:     10.1, modeledResult:     15.3 },
  { state:"LA", senator:"Bill Cassidy",         incRunning:true , incParty:"R" as const, approval:    9, pollingAvg:  4.3, modeledResult:  8.0 },
  { state:"ME", senator:"Susan Collins",        incRunning:true , incParty:"R" as const, approval:  -13, pollingAvg:     -0.1, modeledResult:  -5.0 },
  { state:"MA", senator:"Ed Markey",            incRunning:true , incParty:"D" as const, approval:  -15, pollingAvg: -26.7, modeledResult: -28.8 },
  { state:"MI", senator:"Gary Peters",          incRunning:false, incParty:"D" as const, approval:  -17, pollingAvg:  -2.7, modeledResult:  -4.3 },
  { state:"MN", senator:"Tina Smith",           incRunning:false, incParty:"D" as const, approval:  -16, pollingAvg:  -3.6, modeledResult: -10.6 },
  { state:"MS", senator:"Cindy Hyde-Smith",     incRunning:true , incParty:"R" as const, approval:    9, pollingAvg:     7.3, modeledResult:    7.7 },
  { state:"MT", senator:"Steve Daines",         incRunning:false, incParty:"R" as const, approval:   13, pollingAvg:  -2.4, modeledResult:  17.7 },
  { state:"NE", senator:"Pete Ricketts",        incRunning:true , incParty:"R" as const, approval:    1, pollingAvg:   3.4, modeledResult:   0.5 },
  { state:"NH", senator:"Jeanne Shaheen",       incRunning:false, incParty:"D" as const, approval:   12, pollingAvg:  -7.8, modeledResult: -10.7 },
  { state:"NJ", senator:"Cory Booker",          incRunning:true , incParty:"D" as const, approval:  -19, pollingAvg: null, modeledResult: -22.9 },
  { state:"NM", senator:"Ben Ray Luján",        incRunning:true , incParty:"D" as const, approval:  -20, pollingAvg:  -16.5, modeledResult: -20.8 },
  { state:"NC", senator:"Thom Tillis",          incRunning:false, incParty:"R" as const, approval:    4, pollingAvg:  -6.5, modeledResult:    -8.8 },
  { state:"OH", senator:"Jon Husted",           incRunning:true , incParty:"R" as const, approval:   15, pollingAvg:   -4.7, modeledResult:   -5.5 },
  { state:"OK", senator:"James Lankford",       incRunning:true , incParty:"R" as const, approval:   17, pollingAvg:    32.4, modeledResult:  24.9 },
  { state:"OR", senator:"Jeff Merkley",         incRunning:true , incParty:"D" as const, approval:  -21, pollingAvg: null, modeledResult: -28.0 },
  { state:"RI", senator:"Jack Reed",            incRunning:true , incParty:"D" as const, approval:  -28, pollingAvg: -23.5, modeledResult: -24.8 },
  { state:"SC", senator:"Lindsey Graham",       incRunning:false, incParty:"R" as const, approval:   -2, pollingAvg:     2.9, modeledResult:  1.7 },
  { state:"SD", senator:"Mike Rounds",          incRunning:true , incParty:"R" as const, approval:   23, pollingAvg:    1.1, modeledResult:    6.7 },
  { state:"TN", senator:"Bill Hagerty",         incRunning:true , incParty:"R" as const, approval:   27, pollingAvg:  24.4, modeledResult:  20.4 },
  { state:"TX", senator:"John Cornyn",          incRunning:false, incParty:"R" as const, approval:    6, pollingAvg:   -2.4, modeledResult:  -2.9 },
  { state:"VA", senator:"Mark Warner",          incRunning:true , incParty:"D" as const, approval:  -25, pollingAvg: -21.7, modeledResult: -20.8 },
  { state:"WV", senator:"Shelley Moore Capito", incRunning:true , incParty:"R" as const, approval:   19, pollingAvg:  null, modeledResult:  31.2 },
  { state:"WY", senator:"Cynthia Lummis",       incRunning:false, incParty:"R" as const, approval:   26, pollingAvg:  null, modeledResult:  40.2 },
];
...
const GOV_RAW = [
  { state:"AL", governor:"Kay Ivey",               incRunning:false, incParty:"R" as const, approval:   20, pollingAvg:    8.9, modeledResult:  15.2 },
  { state:"AK", governor:"Mike Dunleavy",          incRunning:true , incParty:"R" as const, approval:  -11, pollingAvg:    0.7, modeledResult:  -13.4 },
  { state:"AZ", governor:"Katie Hobbs",            incRunning:true , incParty:"D" as const, approval:  -14, pollingAvg:  -5.8, modeledResult:  -10.2 },
  { state:"AR", governor:"Sarah Huckabee Sanders", incRunning:true , incParty:"R" as const, approval:   19, pollingAvg:     5.9, modeledResult:  11.3 },
  { state:"CA", governor:"Gavin Newsom",           incRunning:false, incParty:"D" as const, approval:  -26, pollingAvg: -23.1, modeledResult: -27.7 },
  { state:"CO", governor:"Jared Polis",            incRunning:false, incParty:"D" as const, approval:  -21, pollingAvg:   null, modeledResult:   -24.2 },
  { state:"CT", governor:"Ned Lamont",             incRunning:true , incParty:"D" as const, approval:  -33, pollingAvg:   -18.2, modeledResult: -19.3 },
  { state:"FL", governor:"Ron DeSantis",           incRunning:false, incParty:"R" as const, approval:   15, pollingAvg:   0.8, modeledResult:   2.2 },
  { state:"GA", governor:"Brian Kemp",             incRunning:false, incParty:"R" as const, approval:   32, pollingAvg:  2.1, modeledResult:  -2.4 },
  { state:"HI", governor:"Josh Green",             incRunning:true , incParty:"D" as const, approval:  -27, pollingAvg:   null, modeledResult: -43.0 },
  { state:"ID", governor:"Brad Little",            incRunning:true , incParty:"R" as const, approval:   30, pollingAvg:    28.0, modeledResult:  25.7 },
  { state:"IL", governor:"J. B. Pritzker",         incRunning:true , incParty:"D" as const, approval:  -17, pollingAvg:   -22.7, modeledResult: -24.9 },
  { state:"IA", governor:"Kim Reynolds",           incRunning:false, incParty:"R" as const, approval:   -6, pollingAvg:  -5.3, modeledResult:  -7.0 },
  { state:"KS", governor:"Laura Kelly",            incRunning:false, incParty:"D" as const, approval:  -26, pollingAvg:    7.0, modeledResult:    4.9 },
  { state:"ME", governor:"Janet Mills",            incRunning:false, incParty:"D" as const, approval:   -8, pollingAvg:   -9.4, modeledResult: -14.5 },
  { state:"MD", governor:"Wes Moore",              incRunning:true , incParty:"D" as const, approval:  -33, pollingAvg:   -30.3, modeledResult: -37.4 },
  { state:"MA", governor:"Maura Healey",           incRunning:true , incParty:"D" as const, approval:  -33, pollingAvg: -19.6, modeledResult: -27.5 },
  { state:"MI", governor:"Gretchen Whitmer",       incRunning:false, incParty:"D" as const, approval:  -25, pollingAvg:  -7.5, modeledResult: -10.2 },
  { state:"MN", governor:"Tim Walz",               incRunning:false, incParty:"D" as const, approval:   -7, pollingAvg:  -9.2, modeledResult: -15.0 },
  { state:"NE", governor:"Jim Pillen",             incRunning:true , incParty:"R" as const, approval:    6, pollingAvg:   15.5, modeledResult:   9.2 },
  { state:"NV", governor:"Joe Lombardo",           incRunning:true , incParty:"R" as const, approval:   18, pollingAvg:   -0.9, modeledResult:   -5.1 },
  { state:"NH", governor:"Kelly Ayotte",           incRunning:true , incParty:"R" as const, approval:   23, pollingAvg:   14.2, modeledResult:   6.8 },
  { state:"NM", governor:"Michelle Lujan Grisham", incRunning:false, incParty:"D" as const, approval:  -16, pollingAvg:   -8.2, modeledResult: -15.8 },
  { state:"NY", governor:"Kathy Hochul",           incRunning:true , incParty:"D" as const, approval:  -19, pollingAvg: -4.9, modeledResult: -12.0 },
  { state:"OH", governor:"Mike DeWine",            incRunning:false, incParty:"R" as const, approval:   18, pollingAvg:   -1.9, modeledResult:  -2.5 },
  { state:"OK", governor:"Kevin Stitt",            incRunning:false, incParty:"R" as const, approval:    6, pollingAvg:    null, modeledResult:  20.4 },
  { state:"OR", governor:"Tina Kotek",             incRunning:true , incParty:"D" as const, approval:   -6, pollingAvg:  2.3, modeledResult:  -10.6 },
  { state:"PA", governor:"Josh Shapiro",           incRunning:true , incParty:"D" as const, approval:  -34, pollingAvg: -18.3, modeledResult: -21.4 },
  { state:"RI", governor:"Dan McKee",              incRunning:true , incParty:"D" as const, approval:  -12, pollingAvg:   -43.3, modeledResult:   -28.0 },
  { state:"SC", governor:"Henry McMaster",         incRunning:false, incParty:"R" as const, approval:   18, pollingAvg:    8.7, modeledResult:   8.4 },
  { state:"SD", governor:"Larry Rhoden",           incRunning:true , incParty:"R" as const, approval:   28, pollingAvg:    null, modeledResult:  10.8 },
  { state:"TN", governor:"Bill Lee",               incRunning:false, incParty:"R" as const, approval:   26, pollingAvg:    16.5, modeledResult:  16.2 },
  { state:"TX", governor:"Greg Abbott",            incRunning:true , incParty:"R" as const, approval:   12, pollingAvg:   4.1, modeledResult:   3.6 },
  { state:"VT", governor:"Phil Scott",             incRunning:true , incParty:"R" as const, approval:   55, pollingAvg:    -6.3, modeledResult:    -6.6 },
  { state:"WI", governor:"Tony Evers",             incRunning:false, incParty:"D" as const, approval:  -19, pollingAvg:  -4.6, modeledResult:  -7.7 },
  { state:"WY", governor:"Mark Gordon",            incRunning:true , incParty:"R" as const, approval:   42, pollingAvg:    null, modeledResult:  37.3 },
];
        ...
        <div style={{ background: "var(--panel)", border: "1px solid var(--border)", marginBottom: 20, overflow: "hidden", borderRadius: "var(--r-xl)", boxShadow: "var(--shadow-md)" }}>
          ...
          <div style={{ padding: "40px 48px 36px" }}>
            <div style={{ fontSize: 11, letterSpacing: "0.10em", textTransform: "uppercase", color: "var(--muted2)", marginBottom: 14 }}>
              TPSI · 2026 Race Ratings · Updated August 2026
            </div>
