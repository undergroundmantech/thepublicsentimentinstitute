...
const SENATE_RAW = [
  { state:"AL", senator:"Tommy Tuberville",     incRunning:false, incParty:"R" as const, approval:   19, pollingAvg:    15, modeledResult:  12.6 },
  { state:"AK", senator:"Dan Sullivan",         incRunning:true , incParty:"R" as const, approval:   -8, pollingAvg:  -2.8, modeledResult:  -1.3 },
  { state:"AR", senator:"Tom Cotton",           incRunning:true , incParty:"R" as const, approval:   15, pollingAvg:  15.8, modeledResult:  17.8 },
  { state:"CO", senator:"John Hickenlooper",    incRunning:true , incParty:"D" as const, approval:  -22, pollingAvg: -13.2, modeledResult: -17.4 },
  { state:"DE", senator:"Chris Coons",          incRunning:true , incParty:"D" as const, approval:  -20, pollingAvg: -26.2, modeledResult: -25.5 },
  { state:"FL", senator:"Ashley Moody",         incRunning:true , incParty:"R" as const, approval:   17, pollingAvg:     9, modeledResult:   9.3 },
  { state:"GA", senator:"Jon Ossoff",           incRunning:true , incParty:"D" as const, approval:  -18, pollingAvg:    -8, modeledResult: -10.8 },
  { state:"ID", senator:"Jim Risch",            incRunning:true , incParty:"R" as const, approval:   22, pollingAvg:    25, modeledResult:  22.3 },
  { state:"IL", senator:"Dick Durbin",          incRunning:false, incParty:"D" as const, approval:  -12, pollingAvg: -20.2, modeledResult: -23.1 },
  { state:"IA", senator:"Joni Ernst",           incRunning:false, incParty:"R" as const, approval:   -5, pollingAvg:   3.6, modeledResult:  -1.5 },
  { state:"KS", senator:"Roger Marshall",       incRunning:true , incParty:"R" as const, approval:    6, pollingAvg:   5.9, modeledResult:   4.4 },
  { state:"KY", senator:"Mitch McConnell",      incRunning:false, incParty:"R" as const, approval:  -36, pollingAvg:     9, modeledResult:     7 },
  { state:"LA", senator:"Bill Cassidy",         incRunning:true , incParty:"R" as const, approval:    9, pollingAvg:  14.8, modeledResult:  10.4 },
  { state:"ME", senator:"Susan Collins",        incRunning:true , incParty:"R" as const, approval:  -13, pollingAvg:     0, modeledResult:  -5.2 },
  { state:"MA", senator:"Ed Markey",            incRunning:true , incParty:"D" as const, approval:  -15, pollingAvg: -22.3, modeledResult: -24.4 },
  { state:"MI", senator:"Gary Peters",          incRunning:false, incParty:"D" as const, approval:  -17, pollingAvg:  -0.6, modeledResult:  -6.7 },
  { state:"MN", senator:"Tina Smith",           incRunning:false, incParty:"D" as const, approval:  -16, pollingAvg:  -4.7, modeledResult: -12.3 },
  { state:"MS", senator:"Cindy Hyde-Smith",     incRunning:true , incParty:"R" as const, approval:    9, pollingAvg:     9, modeledResult:    11 },
  { state:"MT", senator:"Steve Daines",         incRunning:false, incParty:"R" as const, approval:   13, pollingAvg:  17.5, modeledResult:  10.5 },
  { state:"NE", senator:"Pete Ricketts",        incRunning:true , incParty:"R" as const, approval:    1, pollingAvg:   4.7, modeledResult:   1.7 },
  { state:"NH", senator:"Jeanne Shaheen",       incRunning:false, incParty:"D" as const, approval:   12, pollingAvg:  -5.8, modeledResult: -13.7 },
  { state:"NJ", senator:"Cory Booker",          incRunning:true , incParty:"D" as const, approval:  -19, pollingAvg: -20.2, modeledResult: -19.1 },
  { state:"NM", senator:"Ben Ray Luján",        incRunning:true , incParty:"D" as const, approval:  -20, pollingAvg:  null, modeledResult: -46.3 },
  { state:"NC", senator:"Thom Tillis",          incRunning:false, incParty:"R" as const, approval:    4, pollingAvg:  -5.5, modeledResult:    -7 },
  { state:"OH", senator:"Jon Husted",           incRunning:true , incParty:"R" as const, approval:   15, pollingAvg:   1.8, modeledResult:   0.3 },
  { state:"OK", senator:"James Lankford",       incRunning:true , incParty:"R" as const, approval:   17, pollingAvg:    20, modeledResult:  18.5 },
  { state:"OR", senator:"Jeff Merkley",         incRunning:true , incParty:"D" as const, approval:  -21, pollingAvg: -22.2, modeledResult: -23.9 },
  { state:"RI", senator:"Jack Reed",            incRunning:true , incParty:"D" as const, approval:  -28, pollingAvg: -37.2, modeledResult: -30.9 },
  { state:"SC", senator:"Lindsey Graham",       incRunning:false, incParty:"R" as const, approval:   -2, pollingAvg:     1, modeledResult:  -1.1 },
  { state:"SD", senator:"Mike Rounds",          incRunning:true , incParty:"R" as const, approval:   23, pollingAvg:    25, modeledResult:    21 },
  { state:"TN", senator:"Bill Hagerty",         incRunning:true , incParty:"R" as const, approval:   27, pollingAvg:  22.8, modeledResult:  20.8 },
  { state:"TX", senator:"John Cornyn",          incRunning:false, incParty:"R" as const, approval:    6, pollingAvg:   1.3, modeledResult:  -2.2 },
  { state:"VA", senator:"Mark Warner",          incRunning:true , incParty:"D" as const, approval:  -25, pollingAvg: -19.9, modeledResult: -19.1 },
  { state:"WV", senator:"Shelley Moore Capito", incRunning:true , incParty:"R" as const, approval:   19, pollingAvg:  38.8, modeledResult:  30.3 },
  { state:"WY", senator:"Cynthia Lummis",       incRunning:false, incParty:"R" as const, approval:   26, pollingAvg:  40.8, modeledResult:  34.6 },
];
...
const GOV_RAW = [
  { state:"AL", governor:"Kay Ivey",               incRunning:false, incParty:"R" as const, approval:   20, pollingAvg:    10, modeledResult:  12.1 },
  { state:"AK", governor:"Mike Dunleavy",          incRunning:true , incParty:"R" as const, approval:  -11, pollingAvg:    -2, modeledResult:  -2.8 },
  { state:"AZ", governor:"Katie Hobbs",            incRunning:true , incParty:"D" as const, approval:  -14, pollingAvg:  -6.7, modeledResult:  -8.7 },
  { state:"AR", governor:"Sarah Huckabee Sanders", incRunning:true , incParty:"R" as const, approval:   19, pollingAvg:     1, modeledResult:  11.8 },
  { state:"CA", governor:"Gavin Newsom",           incRunning:false, incParty:"D" as const, approval:  -26, pollingAvg: -17.9, modeledResult: -22.7 },
  { state:"CO", governor:"Jared Polis",            incRunning:false, incParty:"D" as const, approval:  -21, pollingAvg:   -19, modeledResult:   -21 },
  { state:"CT", governor:"Ned Lamont",             incRunning:true , incParty:"D" as const, approval:  -33, pollingAvg:   -19, modeledResult: -23.3 },
  { state:"FL", governor:"Ron DeSantis",           incRunning:false, incParty:"R" as const, approval:   15, pollingAvg:   3.9, modeledResult:   2.4 },
  { state:"GA", governor:"Brian Kemp",             incRunning:false, incParty:"R" as const, approval:   32, pollingAvg:  -5.3, modeledResult:  -8.1 },
  { state:"HI", governor:"Josh Green",             incRunning:true , incParty:"D" as const, approval:  -27, pollingAvg:   -26, modeledResult: -31.6 },
  { state:"ID", governor:"Brad Little",            incRunning:true , incParty:"R" as const, approval:   30, pollingAvg:    40, modeledResult:  32.2 },
  { state:"IL", governor:"J. B. Pritzker",         incRunning:true , incParty:"D" as const, approval:  -17, pollingAvg:   -20, modeledResult: -20.6 },
  { state:"IA", governor:"Kim Reynolds",           incRunning:false, incParty:"R" as const, approval:   -6, pollingAvg:  -4.7, modeledResult:  -4.1 },
  { state:"KS", governor:"Laura Kelly",            incRunning:false, incParty:"D" as const, approval:  -26, pollingAvg:    -2, modeledResult:    -1 },
  { state:"ME", governor:"Janet Mills",            incRunning:false, incParty:"D" as const, approval:   -8, pollingAvg:   -12, modeledResult: -18.5 },
  { state:"MD", governor:"Wes Moore",              incRunning:true , incParty:"D" as const, approval:  -33, pollingAvg:   -15, modeledResult: -30.6 },
  { state:"MA", governor:"Maura Healey",           incRunning:true , incParty:"D" as const, approval:  -33, pollingAvg: -21.9, modeledResult: -30.8 },
  { state:"MI", governor:"Gretchen Whitmer",       incRunning:false, incParty:"D" as const, approval:  -25, pollingAvg:  -6.5, modeledResult: -10.3 },
  { state:"MN", governor:"Tim Walz",               incRunning:false, incParty:"D" as const, approval:   -7, pollingAvg:  -8.8, modeledResult: -13.3 },
  { state:"NE", governor:"Jim Pillen",             incRunning:true , incParty:"R" as const, approval:    6, pollingAvg:   7.9, modeledResult:   9.4 },
  { state:"NV", governor:"Joe Lombardo",           incRunning:true , incParty:"R" as const, approval:   18, pollingAvg:   4.3, modeledResult:   0.2 },
  { state:"NH", governor:"Kelly Ayotte",           incRunning:true , incParty:"R" as const, approval:   23, pollingAvg:   8.4, modeledResult:   4.8 },
  { state:"NM", governor:"Michelle Lujan Grisham", incRunning:false, incParty:"D" as const, approval:  -16, pollingAvg:   -13, modeledResult: -15.1 },
  { state:"NY", governor:"Kathy Hochul",           incRunning:true , incParty:"D" as const, approval:  -19, pollingAvg: -11.2, modeledResult: -15.6 },
  { state:"OH", governor:"Mike DeWine",            incRunning:false, incParty:"R" as const, approval:   18, pollingAvg:   0.7, modeledResult:  -1.3 },
  { state:"OK", governor:"Kevin Stitt",            incRunning:false, incParty:"R" as const, approval:    6, pollingAvg:    14, modeledResult:  11.1 },
  { state:"OR", governor:"Tina Kotek",             incRunning:true , incParty:"D" as const, approval:   -6, pollingAvg:  -0.8, modeledResult:  -9.5 },
  { state:"PA", governor:"Josh Shapiro",           incRunning:true , incParty:"D" as const, approval:  -34, pollingAvg: -17.8, modeledResult: -20.9 },
  { state:"RI", governor:"Dan McKee",              incRunning:true , incParty:"D" as const, approval:  -12, pollingAvg:   -22, modeledResult:   -23 },
  { state:"SC", governor:"Henry McMaster",         incRunning:false, incParty:"R" as const, approval:   18, pollingAvg:    17, modeledResult:   6.8 },
  { state:"SD", governor:"Larry Rhoden",           incRunning:true , incParty:"R" as const, approval:   28, pollingAvg:    27, modeledResult:  20.8 },
  { state:"TN", governor:"Bill Lee",               incRunning:false, incParty:"R" as const, approval:   26, pollingAvg:    22, modeledResult:  16.3 },
  { state:"TX", governor:"Greg Abbott",            incRunning:true , incParty:"R" as const, approval:   12, pollingAvg:   5.5, modeledResult:   3.7 },
  { state:"VT", governor:"Phil Scott",             incRunning:true , incParty:"R" as const, approval:   55, pollingAvg:    12, modeledResult:    20 },
  { state:"WI", governor:"Tony Evers",             incRunning:false, incParty:"D" as const, approval:  -19, pollingAvg:  -0.4, modeledResult:  -6.6 },
  { state:"WY", governor:"Mark Gordon",            incRunning:true , incParty:"R" as const, approval:   42, pollingAvg:    58, modeledResult:  47.6 },
];
