...
const SLIDES: Slide[] = [
...

  {
    ...
    bars:[
      { label:"Karen Bass",            pct:29.7, color:C.blue,    strong:true },
      { label:"Spencer Pratt",         pct:15.2, color:C.pink,    strong:true },
      { label:"Other candidate",       pct:7.7,  color:C.purpleLt },
      { label:"Nithya Raman",          pct:7.2,  color:C.cyan },
      { label:"Adam Miller",           pct:4.6,  color:C.orange },
      { label:"Rae Huang",             pct:4.4,  color:C.green },
      { label:"Not sure / undecided",  pct:31.1, color:C.muted },
    ],
  },

  {
    ...
    bars:[
      { label:"Karen Bass",      pct:39.9, color:C.blue,    strong:true },
      { label:"Spencer Pratt",   pct:21.1, color:C.pink,    strong:true },
      { label:"Nithya Raman",    pct:12.2, color:C.cyan },
      { label:"Rae Huang",       pct:7.8,  color:C.green },
      { label:"Adam Miller",     pct:6.9,  color:C.orange },
      { label:"Other candidate", pct:12.1, color:C.purpleLt },
    ],
  },
...

  {
    ...
    bars:[
      { label:"Democrat",            pct:56.6, color:C.blue,     strong:true },
      { label:"Republican",          pct:16.0, color:C.pink,     strong:true },
      { label:"Independent / Other", pct:27.3, color:C.purpleLt },
    ],
  },
