  ...
  return (
    <section className={`gl-wrap${phase >= 2 ? " is-set" : ""}`} ref={wrapRef} aria-label="The 2026 Senate map on a globe">
      ...
      <style>{`
        ...
        .gl-lime { font-style: normal; color: #b7ff00; font-weight: 650; }
        .gl-cta { display: inline-flex; align-items: center; gap: 9px; margin-top: 28px; padding: 13px 26px; border-radius: 999px; background: #b7ff00; color: #050505;
        ...
        .gl-cta:hover { transform: translateY(-2px); box-shadow: 0 18px 44px rgba(183,255,0,0.24); }
